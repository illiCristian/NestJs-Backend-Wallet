  ...
  return (
    ...
    flex justify-center items-center ${props.isVisible}`}>
      ...
      <Image
            ...
            className='mt-10'
          />
        <h1 className='my-3 font-semibold'>¡Genial! Ya puedes utilizar tu cuenta</h1>
        <p className='my-3 text-blue-400 text-xs mr-[140px]'>Cuenta creada con éxito</p>
        <p className='mb-3 text-xs mr-[14px]'>Inicia sesión con tu móvil o número de teléfono.</p>
