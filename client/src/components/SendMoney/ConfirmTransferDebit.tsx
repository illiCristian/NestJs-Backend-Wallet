...
import DetailMoney from '../TransferDebit/DetailMoney/DetailMoney'
      ...
      <section className="flex flex-row items-start justify-">
        ...
        >
          ...
          <div className="flex flex-row items-end justify-end gap-3 mt-4 mb-9">
            ...
            <Link
              href={'/send-money/success-pay'}
              className="bg-[#00B1EA] px-10 text-base text-center py-2 font-medium  text-white rounded-md w-[175px] h-[48px]"
            >
              Continuar
            </Link>
          </div>
